...
# AI Prompt: the melody should evolve as well into different themes the longer it is played
...
class RhythmicMixPlayer(threading.Thread):
    ...
    def _handle_deconstruct(self, current_rhythm, parts_with_channel):
        ...
        for _ in range(len(build_order) - 1): 
             ...
             self._play_section(current_rhythm, 1 if current_rhythm['beats_per_measure'] > 6 else 2, part_filter=build_filter, custom_parts=parts_with_channel.items())
