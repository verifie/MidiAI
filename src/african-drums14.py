...
# AI Prompt: I have a casio keyboard at home with midi, can we plug this in to it? (ANSWER was display option). OK add in this, but first ask for a output selection then go into the rest of the program, but use the selection
